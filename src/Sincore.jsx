...
const architectureBlocks = [
  { title: 'Data Sources', icon: Database, text: 'Sinhala-native public information sources collected into a structured research corpus.' },
  { title: 'Preprocessing Layer', icon: FileText, text: 'Cleaning, normalization, field organization, and preparation of self-contained text units.' },
  { title: 'Morphology Layer', icon: Languages, text: 'Segmented, stemmed, and token-level representations for Sinhala text.' },
  { title: 'Embedding Layer', icon: Brain, text: 'Sentence-level vector representations generated for semantic retrieval.' },
  { title: 'Lexical Index', icon: Search, text: 'BM25-based retrieval for exact and term-sensitive matching.' },
  { title: 'Vector Index', icon: Boxes, text: 'Dense retrieval over embedded Sinhala text for semantic similarity search.' },
  { title: 'Fusion & Ranking', icon: Scale, text: 'Weighted combination of lexical and dense retrieval signals.' },
  { title: 'Generation Layer', icon: MessageSquareText, text: 'Retrieved evidence is assembled into context and passed to the answering model.' },
];
...
const evaluationSections = [
  {
    ...
    metrics: ['Base model comparison', 'Fine-tuned model comparison', 'Recall@10', 'nDCG', 'MRR', 'Mean Rank'],
...
const team = [
  { name: 'Hasini Sankalpana De Silva', role: 'Research Student', focus: 'Retrieval, morphology-aware processing, evaluation, and system integration' },
  { name: 'Nimeth Indunu Dasanayake', role: 'Research Student', focus: 'Research implementation and project development' },
  { name: 'Pasindu Dilshan Dasanayake', role: 'Research Student', focus: 'Research implementation and project development' },
  { name: 'Dr. Nalaka Lankasena', role: 'Internal Supervisor', focus: 'Academic guidance and research supervision' },
  { name: 'Dr. Iroshan Aberathne', role: 'Co-Supervisor', focus: 'Technical guidance and industry-oriented direction' },
];
...
function Card({ children, className = '' }) {
  return <div className={`rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-slate-950/20 ${className}`}>{children}</div>;
}
...
export default function SinhalaRagResearchWebsiteFull() {
  ...
  <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
    <a href="#home" className="flex items-center gap-3">
      <img src={projectLogo} alt="SinCore logo" className="h-14 w-14 object-contain" />
      <div>
        <p className="text-xs font-semibold uppercase tracking-[0.25em] text-cyan-300">Research Website</p>
        <h1 className="text-base font-bold text-white md:text-lg">SinCore</h1>
      </div>
    </a>
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
                This research explores how morphology-aware processing, hybrid retrieval, and grounded generation can be combined to build a more reliable Sinhala question-answering workflow for low-resource language settings.
              </p>

              <div className="mt-8 flex flex-wrap gap-4">
                <a href="#overview" className="rounded-2xl bg-cyan-400 px-6 py-3 font-semibold text-slate-950 transition hover:scale-[1.02]">
                  Explore Research
                </a>
                ...
                <a href="#results" className="rounded-2xl border border-white/15 px-6 py-3 font-semibold text-white transition hover:bg-white/5">
                  View Results
                </a>
              </div>
              ...
              <div className="mt-10 flex flex-wrap gap-3">
                {quickLinks.map((link) => (
                  <a key={link.href} href={link.href} className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-200 transition hover:bg-white/10">
                    {link.label}
            ...
            <div className="grid gap-4">
              {heroStats.map((stat) => (
                <Card key={stat.label}>
                  <p className="text-sm uppercase tracking-[0.2em] text-cyan-300">{stat.label}</p>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <Card>
              ...
              <p className="mt-4 leading-7 text-slate-300">
                The project is centered on a Sinhala-first retrieval and answering pipeline that treats the language as a native-script research target rather than adapting it only through multilingual shortcuts.
              </p>
            </Card>
            <Card>
              <div className="flex items-center gap-3">
              ...
              <p className="mt-4 leading-7 text-slate-300">
                Improve answer reliability by grounding generated responses in retrieved Sinhala evidence instead of depending only on what a model memorized during pretraining.
              </p>
            </Card>
            <Card>
              <div className="flex items-center gap-3">
                <Target className="h-6 w-6 text-cyan-300" />
                <h3 className="text-xl font-semibold text-white">Research Value</h3>
              </div>
              <p className="mt-4 leading-7 text-slate-300">
                The framework aims to contribute to low-resource NLP by connecting corpus development, morphology-aware processing, retrieval design, and response grounding in one system.
              </p>
            </Card>
          </div>
        </Section>
        ...
        >
          <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
            <Card>
              <p className="text-sm uppercase tracking-[0.2em] text-cyan-300">Main Objective</p>
              <p className="mt-4 text-lg leading-8 text-slate-200">{objectives.main}</p>
            </Card>
            <Card>
              <p className="text-sm uppercase tracking-[0.2em] text-cyan-300">Specific Objectives</p>
        ...
        >
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {gaps.map((gap) => (
              <Card key={gap.title}>
                <h3 className="text-xl font-semibold text-white">{gap.title}</h3>
            ...
            {architectureBlocks.map((block, idx) => {
              ...
              return (
                <Card key={block.title}>
                  ...
                  <div className="mb-3 inline-flex rounded-full border border-white/10 px-3 py-1 text-xs text-slate-300">Step {idx + 1}</div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <Card>
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-white">Knowledge Preparation Layer</h3>
              </div>
              <div className="mt-6 space-y-3">
                {offlinePipeline.map((step, idx) => (
                  <div key={step} className="flex gap-4 rounded-2xl border border-white/10 bg-white/5 p-4">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-cyan-400/15 text-sm font-bold text-cyan-200">{idx + 1}</div>
            ...
            <Card>
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-white">Query Processing Layer</h3>
              </div>
              <div className="mt-6 space-y-3">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
              ...
              <Card key={section.title}>
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  {section.metrics.map((metric) => (
                    <span key={metric} className="rounded-full border border-cyan-400/25 bg-cyan-400/10 px-3 py-1.5 text-sm text-cyan-100">
                      {metric}
                    </span>
                  ))}
                </div>
            ...
            <Card className="lg:col-span-2 overflow-hidden border-cyan-400/20 bg-gradient-to-br from-slate-900/95 to-slate-950/95 p-0">
              <div className="border-b border-white/10 bg-white/5 px-6 py-5">
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div>
                    <p className="text-sm uppercase tracking-[0.2em] text-cyan-300">Model Comparison</p>
                    <h3 className="mt-1 text-2xl font-semibold text-white">Embedding Models Evaluation</h3>
                    <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-300">
                      Multiple candidate embedding models were evaluated in their base form and again after fine-tuning to select the strongest model for semantic retrieval.
                    </p>
                  </div>
              ...
              <div className="grid gap-6 p-6 lg:grid-cols-2">
                <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04]">
                  <div className="border-b border-white/10 bg-cyan-400/10 px-5 py-4">
                    <p className="text-sm font-semibold uppercase tracking-[0.2em] text-cyan-200">Base Models</p>
                  </div>
                    ...
                    <table className="w-full min-w-[520px] text-left text-sm text-slate-300">
                      ...
                      <tbody>
                        <tr className="border-b border-white/5 transition hover:bg-white/[0.04]">
                          <td className="px-5 py-4 font-medium text-white">SinBERT</td>
                        ...
                        <tr className="border-b border-white/5 transition hover:bg-white/[0.04]">
                          <td className="px-5 py-4 font-medium text-white">mMiniLM</td>
                        ...
                        <tr className="transition hover:bg-white/[0.04]">
                          <td className="px-5 py-4 font-medium text-white">mBERT</td>
                ...
                <div className="overflow-hidden rounded-3xl border border-emerald-400/20 bg-emerald-400/[0.06]">
                  <div className="border-b border-emerald-400/15 bg-emerald-400/10 px-5 py-4">
                    <p className="text-sm font-semibold uppercase tracking-[0.2em] text-emerald-200">Fine-Tuned Models</p>
                  </div>
                  <div className="overflow-x-auto">
                    <table className="w-full min-w-[520px] text-left text-sm text-slate-200">
                      ...
                      <tbody>
                        ...
                        <tr className="border-b border-white/5 bg-emerald-400/[0.08] transition hover:bg-emerald-400/[0.12]">
                          <td className="px-5 py-4 font-semibold text-white">mMiniLM</td>
                          <td className="px-4 py-4 font-semibold text-emerald-100">0.788</td>
                          <td className="px-4 py-4 font-semibold text-emerald-100">0.682</td>
                          <td className="px-4 py-4 font-semibold text-emerald-100">0.631</td>
                          <td className="px-4 py-4 font-semibold text-emerald-100">12.9</td>
                        </tr>
              ...
              <div className="border-t border-white/10 px-6 py-6">
                <p className="text-sm uppercase tracking-[0.2em] text-cyan-300">Key Insight</p>
                <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-5">
                  <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4 text-sm leading-6 text-slate-300 md:col-span-2 xl:col-span-2">
                    Fine-tuning improved every model across recall, ranking, and relevance metrics, showing that task-specific adaptation was important for Sinhala retrieval.
                  </div>
                  ...
                  <div className="rounded-2xl border border-emerald-400/20 bg-emerald-400/10 p-4 text-sm leading-6 text-emerald-100">
                    It produced the lowest Mean Rank, so it was selected as the final embedding model.
                  </div>
                </div>
              </div>
            </Card>
            <Card className="lg:col-span-2 overflow-hidden border-blue-400/20 bg-gradient-to-br from-slate-900/95 to-slate-950/95 p-0">
              <div className="border-b border-white/10 bg-white/5 px-6 py-5">
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div>
                    <p className="text-sm uppercase tracking-[0.2em] text-cyan-300">Method Comparison</p>
                    <h3 className="mt-1 text-2xl font-semibold text-white">Retrieval Evaluation</h3>
                    <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-300">
                      Lexical, semantic, and hybrid retrieval methods were evaluated to identify the most effective strategy for retrieving relevant Sinhala content.
                    </p>
                  </div>
              ...
              <div className="p-6">
                <div className="overflow-hidden rounded-3xl border border-blue-400/20 bg-blue-400/[0.05]">
                  <div className="border-b border-blue-400/15 bg-blue-400/10 px-5 py-4">
                    <p className="text-sm font-semibold uppercase tracking-[0.2em] text-blue-200">Retrieval Performance Comparison</p>
                  </div>
                  <div className="overflow-x-auto">
                    <table className="w-full min-w-[760px] text-left text-sm text-slate-200">
                      <thead>
                        <tr className="border-b border-blue-400/10 bg-white/[0.03]">
                          <th className="px-5 py-4 font-semibold">Retrieval Method</th>
                          ...
                          <th className="px-4 py-4 font-semibold">MRR</th>
                          <th className="px-4 py-4 font-semibold">Precision@5</th>
                          <th className="px-4 py-4 font-semibold">Coverage@5</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className="border-b border-white/5 transition hover:bg-white/[0.05]">
                          <td className="px-5 py-4 font-medium text-white">BM25 (Lexical)</td>
                        ...
                        <tr className="border-b border-white/5 transition hover:bg-white/[0.05]">
                          <td className="px-5 py-4 font-medium text-white">Vector (Semantic)</td>
                        ...
                        <tr className="bg-blue-400/[0.08] transition hover:bg-blue-400/[0.12]">
                          <td className="px-5 py-4 font-semibold text-white">Hybrid</td>
                          <td className="px-4 py-4 font-semibold text-blue-100">0.32</td>
                          <td className="px-4 py-4 font-semibold text-blue-100">0.58</td>
                          <td className="px-4 py-4 font-semibold text-blue-100">0.66</td>
                          <td className="px-4 py-4 font-semibold text-blue-100">0.452</td>
                          <td className="px-4 py-4 font-semibold text-blue-100">0.19</td>
                          <td className="px-4 py-4 font-semibold text-blue-100">0.449</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
              ...
              <div className="border-t border-white/10 px-6 py-6">
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                  <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4 text-sm leading-6 text-slate-300 xl:col-span-2">
                    Hybrid retrieval achieved the strongest overall performance, showing that combining lexical precision with semantic similarity produced more reliable retrieval than either method alone.
                  </div>
                  <div className="rounded-2xl border border-blue-400/20 bg-blue-400/10 p-4 text-sm leading-6 text-blue-100">
                    Hybrid produced the highest Recall@1, Recall@3, and Recall@5.
                  </div>
                  <div className="rounded-2xl border border-blue-400/20 bg-blue-400/10 p-4 text-sm leading-6 text-blue-100">
                    It also achieved the best MRR, Precision@5, and Coverage@5, making it the final retrieval strategy.
                  </div>
                </div>
              </div>
            </Card>
              ...
              <div className="border-b border-white/10 bg-white/5 px-6 py-5">
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div>
                    <p className="text-sm uppercase tracking-[0.2em] text-cyan-300">System Comparison</p>
                    <h3 className="mt-1 text-2xl font-semibold text-white">Morphology Comparison</h3>
                    <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-300">
                      Retrieval performance was compared between the non-morphology baseline and the morphology-aware system across lexical, semantic, and hybrid retrieval modes.
                    </p>
                  </div>
              ...
              <div className="p-6">
                <div className="overflow-hidden rounded-3xl border border-violet-400/20 bg-violet-400/[0.05]">
                  <div className="border-b border-violet-400/15 bg-violet-400/10 px-5 py-4">
                    <p className="text-sm font-semibold uppercase tracking-[0.2em] text-violet-200">Morphology-Aware vs Non-Morphology Comparison</p>
                  </div>
                  <div className="overflow-x-auto">
                    <table className="w-full min-w-[900px] text-left text-sm text-slate-200">
                      <thead>
                        <tr className="border-b border-violet-400/10 bg-white/[0.03]">
                          <th className="px-5 py-4 font-semibold">System Type</th>
                          <th className="px-4 py-4 font-semibold">Retrieval Mode</th>
                          <th className="px-4 py-4 font-semibold">Recall@1</th>
                          <th className="px-4 py-4 font-semibold">Recall@3</th>
                          <th className="px-4 py-4 font-semibold">Recall@5</th>
                          <th className="px-4 py-4 font-semibold">MRR</th>
                      ...
                      <tbody>
                        <tr className="border-b border-white/5 transition hover:bg-white/[0.05]">
                          <td className="px-5 py-4 font-medium text-white">Non-Morph</td>
                        ...
                        <tr className="border-b border-white/5 bg-violet-400/[0.06] transition hover:bg-violet-400/[0.1]">
                          <td className="px-5 py-4 font-semibold text-white">Morph</td>
                          <td className="px-4 py-4 font-medium text-violet-100">Lexical</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.19</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.40</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.50</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.297</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.13</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.31</td>
                        </tr>
                        <tr className="border-b border-white/5 bg-violet-400/[0.06] transition hover:bg-violet-400/[0.1]">
                          <td className="px-5 py-4 font-semibold text-white">Morph</td>
                          <td className="px-4 py-4 font-medium text-violet-100">Semantic</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.28</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.52</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.60</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.406</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.176</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.415</td>
                        </tr>
                        <tr className="bg-violet-400/[0.12] transition hover:bg-violet-400/[0.16]">
                          <td className="px-5 py-4 font-semibold text-white">Morph</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">Hybrid</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.32</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.58</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.66</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.452</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.19</td>
                          <td className="px-4 py-4 font-semibold text-violet-100">0.449</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
              ...
              <div className="border-t border-white/10 px-6 py-6">
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                  <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4 text-sm leading-6 text-slate-300 xl:col-span-2">
                    The morphology-aware system outperformed the non-morphology baseline across all retrieval modes, showing that explicit handling of Sinhala word variation improved retrieval effectiveness.
                  </div>
                  <div className="rounded-2xl border border-violet-400/20 bg-violet-400/10 p-4 text-sm leading-6 text-violet-100">
                    The biggest gains appear in lexical retrieval, where morphology-aware processing improves exact-term matching and ranking.
                  </div>
                  <div className="rounded-2xl border border-violet-400/20 bg-violet-400/10 p-4 text-sm leading-6 text-violet-100">
                    The morphology-aware hybrid setting achieved the strongest overall result, making it the best-performing configuration in the comparison.
                  </div>
                </div>
              </div>
            </Card>
        ...
        >
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-3">
            <Card>
              <p className="text-sm uppercase tracking-[0.2em] text-cyan-300">Comparison View</p>
              <h3 className="mt-3 text-xl font-semibold text-white">Baseline vs Improved System</h3>
              <p className="mt-4 leading-7 text-slate-300">
                Show comparisons between non-morphology and morphology-aware retrieval, as well as lexical, semantic, and hybrid modes.
              </p>
            </Card>
            <Card>
              <p className="text-sm uppercase tracking-[0.2em] text-cyan-300">Metric View</p>
              <h3 className="mt-3 text-xl font-semibold text-white">Retrieval and Generation Metrics</h3>
              <p className="mt-4 leading-7 text-slate-300">
                Highlight the most meaningful metrics visually so viewers can understand system quality without reading dense analysis sections.
              </p>
            </Card>
            <Card>
              <p className="text-sm uppercase tracking-[0.2em] text-cyan-300">Interpretation View</p>
              <h3 className="mt-3 text-xl font-semibold text-white">Key Findings</h3>
              <p className="mt-4 leading-7 text-slate-300">
                Summarize what improved, where the system still struggles, and why the research design choices matter for Sinhala NLP.
              </p>
            </Card>
        ...
        >
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
            {technologies.map((tech) => (
              <Card key={tech} className="flex min-h-[120px] items-center justify-center text-center">
                <div>
                  {technologyIcons[tech] ? (
                    <img src={technologyIcons[tech]} alt="" className="mx-auto h-6 w-6" loading="lazy" />
                  ) : (
